...
defaulstyle = ImageGaugeStyle(width=320, height=360, bgcolor="#000000", alertcolor="#f0b01d",
...
screens = [
    # Driving Parms
    [
        GaugeDef(name='throttle_position', gaugeclass=ImageGauge(gaugestyle=defaultstyle, 
                    gaugeconfig=ImageGaugeConfig(displayname="Throtle", unit="%", altunit=None, min=-0, max=100, alertval=95, fmtstring='{0:.0f}'))),
        ...
        GaugeDef(name='steering_wheel_angle', gaugeclass=ImageGauge(gaugestyle=defaultstyle, 
